...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driver" do
    assert_difference('Driver.count') do
      post drivers_url, params: { driver: { last_name: @driver.last_name, name: @driver.name } }
    end
  ...
  test "should update driver" do
    patch driver_url(@driver), params: { driver: { last_name: @driver.last_name, name: @driver.name } }
